...
public class ImagemClienteController {

    private static final Logger logger = LoggerFactory.getLogger(ImagemClienteController.class);

    // Caminho correto da sua pasta de imagens
    private final String diretorioImagens = "C:/pasta-faculdade/emark/src/main/resources/static/imagemCliente";
    ...
    public ResponseEntity<Resource> obterImagem(@PathVariable Integer id) throws MalformedURLException {
        logger.info("Requisição recebida para imagem do cliente com id: {}", id);
